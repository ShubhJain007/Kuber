...
encoder embeds each element and applies an $L_s$-layer pre-norm Transformer with multi-head
self-attention (MHSA):
\begin{equation}
...
For each query $x_j$, let $\mathcal{N}_k(j)$ be its $k$ nearest surface points; with relative positions
